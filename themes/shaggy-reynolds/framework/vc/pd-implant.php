...
function pd_implant_func( $atts, $content = null ) {
  ...
  $html = '
    <div class="implant">
        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . get_template_directory_uri() . '/assets/images/straumann-pure-implant.png" alt="implant">
